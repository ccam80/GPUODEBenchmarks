...
--resume runs what the store lacks of each trial: a transfers row, a cold build time, a readable finals file, a valid optimize record, a row recorded after that record; --no-overwrite also reruns NaN rows and timed-out optimizes; --floor lets runners keep the lower finite time.
