...
plan writes trials/<key>/<package>.jsonl and prints counts; run writes them under logs/<key>_<stamp>/ and drives each package's runner, a fresh cubie runner every 12 optimizes at a family boundary (<package>.part<N>.jsonl).
