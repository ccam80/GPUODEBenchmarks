...
step at `duration * adaptive.dt_min_fraction`; DiffEqGPU's kernels take no
floor and stop at 1e-14 on their own. Nothing else is set: every package runs
its shipped step-controller defaults.
