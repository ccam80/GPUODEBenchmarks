...
#
# Usage: ./run_benchmark.sh -p <package> [-a <analysis>] [-n <nmax>] [-g <algorithm>] [-d <device>] [-m <model>] [--keep] [--resume] [--no-overwrite] [--resume-from <point>] [--floor]
...
#   --floor         re-run the selected points and keep the lower of the recorded and new time; implies --keep
