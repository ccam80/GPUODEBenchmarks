...
- `golden_<problem>_131072.csv` — 131072 rows of final states; the
  ...
  unless `--force`.
- The ne ensemble is the first 1024 rows of `golden_<problem>_131072.csv`.
- `golden_ne_<problem>_1024.csv` — `<sweep>,<states...>` grid and reference of the `ne_legacy_grid` problems in `runner_scripts/protocol.toml`, from `runner_scripts/numerical_equivalence/generate_golden_ne.jl`.
